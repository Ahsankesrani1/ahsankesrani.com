...
@section('content')
    <!-- ========== About Section ========== -->
    <section class="about-section p-relative section-margin " data-dsn-title="How We Are" data-dsn-animate-multi
                    ...
                    <div class="box-info pt-60 pb-60">
                        <div class="title-move z-index-1 " data-dsn-grid="move-section" data-dsn-move="-70"
                            ...
                            <h2 class="section-title mb-30 dsn-text-shadow text-transform-upper">
                                Hello We are , <br /> Software Developer
                            </h2>
                        </div>
                        <h6 class="mt-80 pb-30 mb-30 border-bottom title-block">We're a software Developer that specialises in
                            creating custom websites and applications.
                        </h6>
                        <p class="max-w570 dsn-up mb-10 ">
                            Ahsan Kesrani is a Pakistani software developer with over two years of expertise.
                        </p>
                        <p class="max-w570 dsn-up mb-30 ">
                            The secret of creative genius is revealed, bringing life-changing creative practises at the
                            fingertips of everyone. His array of powerful creative thinking skills can be applied to
                            practically any technological problem or to generate new concepts. His tools are without a doubt
                            the closest thing to a tactical instruction manual for thinking like a genius there is. His
                            tools will help you see difficulties in a new light, and you'll uncover an universe of
                            innovative solutions to common and not-so-common situations.
                        </p>
...
Ahsan Kesrani
                    ...
                    <div class="background-mask p-20 p-absolute h-100 w-100">
                        ...
                        <div class="img-box h-100">
                            <div class="img-container h-100 before-z-index" data-dsn-grid="move-up" data-overlay="3">
                                <img class="cover-bg-img " src="{{ asset('./assets/img/experience.png') }}" alt="">
                            </div>
                        </div>
    ...
    <!-- ========== End About Section ========== -->
    <!-- ========== Service Section ========== -->
    <section class="services with-line with-number p-relative section-margin dsn-col" data-dsn-title="Our Services">
                ...
                <div class="col-md-6 col-lg-4 dsn-col-lg-3 dsn-col-md-2 dsn-col-sm-1 services-item grid-item dsn-up">
                    <div class="services-item-inner">
                        ...
                        <div class="services-content background-section">
                            ...
                            <div class="service-description">
                                <h4 class="title-block mb-15">Web Development</h4>
                ...
                <div class="col-md-6 col-lg-4 dsn-col-lg-3 dsn-col-md-2 dsn-col-sm-1 services-item grid-item dsn-up">
                    <div class="services-item-inner">
                        ...
                        <div class="services-content background-section">
                            ...
                            <div class="service-description">
                                <h4 class="title-block mb-15">Program management</h4>
    ...
    <div class="box-seat box-seat-parallax section-margin">
        ...
        <div class="inner-img h-100-v" data-dsn-grid="move-up" data-overlay="2">
            <img class="transform-3d has-bigger-scale" src="{{ asset('./assets/img/plan-project.jpg') }}" alt="">
        </div>
        <div class="pro-text background-section box-padding" data-dsn-grid="move-section" data-dsn-responsive="tablet">
            ...
            <a href="#" class="mt-30 dsn-button image-zoom" data-dsn="parallax">
    ...
    <!-- ========== Work Section ========== -->
    <section class="work-section p-relative section-margin dsn-swiper over-hidden" data-dsn-title="our Portfolio"
        data-dsn-option='{"slidesPerView":1.5,"spaceBetween":50}'>
        <div class="container mb-70 d-flex text-center flex-column align-items-center">
            ...
            <div class="swiper-wrapper v-dark-head">
                <div class="swiper-slide over-hidden work-item">
                    <div class="box-img p-relative over-hidden before-z-index" data-overlay="6"
                        ...
                        <img class="cover-bg-img" src="{{ asset('./assets/img/project/medipedia.png') }}" alt="">
                    </div>

                    <div class="box-content" data-swiper-parallax-opacity="0">
                        <div class="metas d-inline-block mb-15">
                            <a href="https://medipedia.ahsankesrani.com/">MEDIPEDIA</a>
                        </div>
                    </div>
                </div>
                <div class="swiper-slide over-hidden work-item">
                    <div class="box-img p-relative over-hidden before-z-index" data-overlay="6"
                        data-swiper-parallax-scale="0.85">
                        <img class="cover-bg-img" src="{{ asset('./assets/img/project/1.jpeg') }}" alt="">
                    </div>

                    <div class="box-content" data-swiper-parallax-opacity="0">
                        <div class="metas d-inline-block mb-15">
                            <span>ME BLOG</span> <span>Blogs</span>
                        </div>
                    </div>
                </div>
                <div class="swiper-slide over-hidden work-item">
                    <div class="box-img p-relative over-hidden before-z-index" data-overlay="4"
                        data-swiper-parallax-scale="0.85">
                        <img class="cover-bg-img" src="{{ asset('./assets/img/project/2.jpeg') }}" alt="">
                    </div>
                    ...
                    <div class="box-content" data-swiper-parallax-opacity="0">
                        ...
                        {{-- <h4 class="sec-title">
                            <a class="effect-ajax" data-dsn-ajax="work" href="project6.html">Lengshuikeng</a>
                        </h4> --}}
                    </div>
                </div>
                <div class="swiper-slide over-hidden work-item">
                    <div class="box-img p-relative over-hidden before-z-index" data-overlay="6"
                        data-swiper-parallax-scale="0.85">
                        <img class="cover-bg-img" src="{{ asset('./assets/img/project/3.jpeg') }}" alt="">
                    </div>

                    <div class="box-content" data-swiper-parallax-opacity="0">
                        <div class="metas d-inline-block mb-15">
                            <span> Abooco Silk Palace</span> <span>Boutique</span>
                        </div>
                        {{-- <h4 class="sec-title">
                ...
                <div class="swiper-slide over-hidden work-item">
                    <div class="box-img p-relative over-hidden before-z-index" data-overlay="6"
                        data-swiper-parallax-scale="0.85">
                        <img class="cover-bg-img" src="{{ asset('assets/img/project/4.jpeg') }}" alt="">
                    </div>

                    <div class="box-content" data-swiper-parallax-opacity="0">
                        <div class="metas d-inline-block mb-15">
                            <span>Muhammad Hussain</span> <span>Estate Agency</span>
                        </div>
                        {{-- <h4 class="sec-title">
                ...
                <div class="swiper-slide over-hidden work-item">
                    <div class="box-img p-relative over-hidden before-z-index" data-overlay="2"
                        data-swiper-parallax-scale="0.85">
                        <img class="cover-bg-img" src="{{ asset('assets/img/project/5.jpeg') }}" alt="">
                    </div>

                    <div class="box-content" data-swiper-parallax-opacity="0">
                        <div class="metas d-inline-block mb-15">
                            <span> Green Travel & Tours </span>
                        </div>
                        {{-- <h4 class="sec-title">
                    ...
                    <div class="col-lg-4 ">
                        <div class="text-left">
                            <h2 class="section-title" data-dsn-grid="move-section" data-dsn-move="-60"
                                data-dsn-duration="100%" data-dsn-opacity="1" data-dsn-responsive="tablet">Feedback from our
                                clients.</h2>
                        </div>
                    </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide d-flex align-items-center">
                                                ...
                                                <div class="box-text" data-swiper-parallax="30%"
                                                    ...
                                                    <h4 class="title-block mb-10">alexzee5 </h4>
                                                    <h5 class="sm-title-block">Fiverr Customer</h5>
                                                </div>
                                            </div>
                                            <div class="swiper-slide d-flex align-items-center">
                                                {{-- <div class="box-img mr-15" data-swiper-parallax-scale="0.7">
                                                ...
                                                <div class="box-text" data-swiper-parallax="30%"
                                                    data-swiper-parallax-opacity="0">
                                                    <h4 class="title-block mb-10">newtimio88</h4>
                                                    <h5 class="sm-title-block">Fiverr Customer</h5>
                                                </div>
                                            </div>
                                            ...
                                            <div class="swiper-slide d-flex align-items-center">
                                                ...
                                                <div class="box-text" data-swiper-parallax="30%"
                                                    data-swiper-parallax-opacity="0">
                                                    <h4 class="title-block mb-10">Waria</h4>
                                                    <h5 class="sm-title-block">Fiverr Customer</h5>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="swiper-container">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <p>"committed to her work and coding motivated by her service, I would strongly
                                                recommend her to anyone searching for a backend or full stack developer.!"
                                            </p>
                                        </div>

                                        <div class="swiper-slide">
                                            <p>"Excellent service and a product that was delivered on time. He was open to
                                                working with me and communicated well. On future projects, I'll be
                                                collaborating with him.!"
                                            </p>
                                        </div>

                                        <div class="swiper-slide">
                                            <p>"I would employ his services again in a heartbeat. He was quite helpful and
                                                responsive, especially considering the time difference. He was really
                                                patient with all of my inquiries, as I had never made a website before. The
                                                end outcome was just what I had hoped. It is a lovely website."</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row dsn-z-index-2">
                <div class="col-lg-6  dsn-z-index-2 pr-0 mb-lg-section">
                    <div class="box-im h-100 p-absolute">
                        <div class="img-container h-100 before-z-index" data-dsn-grid="move-up" data-overlay="3">
                            <img class="cover-bg-img img-fluid" src="{{ asset('./assets/img/plan-project.jpg') }}" alt="">
                        </div>
    ...
    <!-- ========== team Section ========== -->
    {{-- <section class="team section-margin p-relative" data-dsn-animate="section" data-dsn-title="our team">
        <div class="container mb-70 d-flex text-center flex-column  align-items-center">
            <p class="sub-heading line-shap line-shap-before mb-15">
                <span class="line-bg-right">
                    Our Team
                    ...
                    <div class="team-item-inner">
                        <div class="team-item-wapper background-section">
                            <div class="item-content d-flex a-item-center">
                                <div class="box-img">
                                    <img class="cover-bg-img" src="{{ './assets/img/ahsankesrani.jpg' }}" alt="">
                                </div>
                                <div class="box-text">
                                    <h4 class="sm-title-block mb-5">Ak Tech Solution</h4>
                                    <h5 class="theme-color">CEO</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="team-item-inner">
                        <div class="team-item-wapper background-section">
                            <div class="item-content d-flex a-item-center">
                                ...
                                <div class="box-text">
                                    <h4 class="sm-title-block mb-5">Muhammad Aman </h4>
                                    <h5 class="theme-color">Mr Coder</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="team-item-inner">
                        <div class="team-item-wapper background-section">
                            <div class="item-content d-flex a-item-center">
                                ...
                                <div class="box-text">
                                    <h4 class="sm-title-block mb-5">Umer Muqtiyar</h4>
                                    <h5 class="theme-color">Mr Backend</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="team-item-inner">
                        <div class="team-item-wapper background-section">
                            <div class="item-content d-flex a-item-center">
                                ...
                                <div class="box-text">
                                    <h4 class="sm-title-block mb-5">Muhammad Qayum</h4>
                                    <h5 class="theme-color">Mobile App Developer..</h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="team-item-wapper background-section">
                            <div class="item-content d-flex a-item-center">
                                <div class="box-img">
                                    ...
                                    src="{{ './assets/img/ahsankesrani.jpg' }}" alt="">
                                </div>
                                <div class="box-text">
                                    <h4 class="sm-title-block mb-5">Arsalan Imtiaz</h4>
                                    <h5 class="theme-color">Mr designer</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="team-item-inner">
                        <div class="team-item-wapper background-section">
                            <div class="item-content d-flex a-item-center">
                                ...
                                <div class="box-text">
                                    <h4 class="sm-title-block mb-5">Ali Haider</h4>
                                    <h5 class="theme-color">Mr Backend</h5>
                                </div>
                            </div>
                        </div>
            ...
            <div class="wrapper-client dsn-up">
                <div class="logo-box col-md-4">
                    <div class="logo-box-inner">
                        <img class="img-fluid" src="{{ './assets/img/protfolio/b1.png' }}" alt="">
                    </div>
                </div>
                <div class="logo-box col-md-4">
                    <div class="logo-box-inner">
                        <img class="img-fluid" src="{{ './assets/img/protfolio/b2.png' }}" alt="">
                    </div>
                </div>
                <div class="logo-box col-md-4">
                    <div class="logo-box-inner">
                        <img class="img-fluid" src="{{ './assets/img/protfolio/b3.png' }}" alt="">
                    </div>
                </div>
                <div class="logo-box col-md-4">
                    <div class="logo-box-inner">
                        <img class="img-fluid" src="{{ './assets/img/protfolio/b4.png' }}" alt="">
                    </div>
                </div>
                <div class="logo-box col-md-4">
                    <div class="logo-box-inner">
                        <img class="img-fluid" src="{{ './assets/img/protfolio/b5.png' }}" alt="">
                    </div>
                </div>
                <div class="logo-box col-md-4">
                    <div class="logo-box-inner">
                        <img class="img-fluid" src="{{ './assets/img/protfolio/b7.jpeg' }}" alt="">
                    </div>
                </div>
                <div class="logo-box col-md-4">
                    <div class="logo-box-inner d-flex justify-content-center">
                        <h5>This Point Awaites You</h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="c-wapp d-flex justify-content-between">
                ...
                <div class="button-box d-flex justify-content-end align-items-center">
                    <div>
                        <a href="#" class="mt-30 effect-ajax dsn-button p-relative">
