...
<head>
    ...
    <meta name="keyword" content="Ahsan Kesrani is a Web Developer with over two years of experience." />
    <!--  Title -->
    <title>Ahsan kesrani | Web Developer</title>
...
<body class="v-dark dsn-line-style dsn-effect-scroll dsn-cursor-effect dsn-ajax">
    ...
    <div class="preloader">
        ...
        <h1 class="title v-middle">
            <span class="text-strok">AHSAN KESRANI</span>
            <span class="text-fill">AHSAN KESRANI</span>
        </h1>
    </div>
    <!-- ========== End Loading Page ========== -->
            ...
            <div class="inner-header p-relative">
                <div class="main-logo">
                    <a href="/" data-dsn="parallax">
                        <img class="light-logo" src="{{ './assets\img\protfolio\b6.png' }}" alt="" />
                        <img class="dark-logo" src="{{ './assets/img/protfolio\b6.png' }}" alt="" />
                    </a>
                </div>
            </div>
                ...
                <div class="container-content  p-absolute h-100 left-60 d-flex flex-column justify-content-center">
                    <div class="nav__info">
                        ...
                        <div class="nav-content">
                            ...
                            <p class="links over-hidden">
                                <a href="#" data-hover-text="+92 306 2367977" class="link-hover">+92 306
                                    2367977</a>
                            </p>
                            <p class="links  over-hidden">
                                <a href="mailto:info@ahsankesrani.com" data-hover-text="info@ahsankesrani.com"
                                    class="link-hover">info@ahsankesrani.com</a>
                            </p>
                        </div>
                    </div>
                    <div class="nav-social nav-content">
                        <div class="nav-social-inner p-relative">
                            ...
                            <ul>
                                <li>
                                    <a href="https://www.fiverr.com/ahsankesrani" target="_blank" rel="nofollow">Fiver.
                                        <div class="icon-circle"></div>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.upwork.com/freelancers/~0162e6fd67a2f3e0bc" target="_blank"
                                        rel="nofollow">Upwork.
                                        <div class="icon-circle"></div>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.linkedin.com/in/ahsan-kesrani-a9b42a234/" target="_blank"
                                ...
                                <li>
                                    <a href="https://twitter.com/ahsan_kesrani1" target="_blank"
                                    ...
                                    <div class="input__wrap controls">
                                        ...
                                        <div class="form-group">
                                            <div class="entry-box">
                                                ...
                                                <textarea id="form_message" class="form-control" name="message" placeholder="Tell us about you and the world"
                            ...
                            <div class="box-info-contact">
                                <ul>
                                    <li>
                                        ...
                                        <p class="text-p">+92 3062367977</p>
                                        <div class="over-hidden mt-5">
                                            <a class="link-hover" data-hover-text="info@ahsankesrani.com"
                                                href="mailto:info@ahsankesrani.com">info@ahsankesrani.com</a>
                                        </div>

                                    </li>
                                    <li>
                                        <h5 class="title-block mb-15">Address</h5>
                                        <p class="text-p">Shaheed E Millat <br> Tariq Road</p>
                                    </li>
                                    <li>
                                        <h5 class="title-block mb-15">Follow</h5>
                                        <div class="social-item over-hidden">
                                            <a class="link-hover" data-hover-text="Instagram."
                                                href="https://www.instagram.com/ahsan.kesrani/?hl=en" target="_blank"
                                                rel="nofollow">Instagram.</a>
                                        </div>
                                        <div class="social-item over-hidden">
                                            <a class="link-hover" data-hover-text="Facebook."
                                                href="https://www.facebook.com/ahsan.kesrani.5" target="_blank"
                                                rel="nofollow">Facebook.</a>
                                        </div>
                                        <div class="social-item over-hidden">
                                            <a class="link-hover" data-hover-text="Linkedin."
                                                href="https://www.linkedin.com/in/ahsan-kesrani-a9b42a234/"
    ...
    <div class="social-side social-network d-flex align-items-center ">
        ...
        <ul class="socials d-flex flex-column p-absolute ">
            ...
            <li>
                <a href="https://www.facebook.com/ahsan.kesrani.5" target="_blank">
